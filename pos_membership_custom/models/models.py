...
class ResPartner(models.Model):
    ...
    gender_m = fields.Char(string="Gender")
...
class MembershipCard(models.Model):
    ...
    def create(self, vals):
        ...
        for rec in record:
            if rec.customer_id:
                ...
                rec.customer_id.membership_type = rec.membership_id.name
    ...
    def write(self, vals):
        ...
        for rec in self:
            if rec.customer_id:
                # Re-apply updates to the customer
                rec.customer_id.is_member_pos = True
                rec.customer_id.membership_type = rec.membership_id.name
...
class PosSession(models.Model):
    ...
    def _loader_params_res_partner(self):
        ...
        add_list = ["custom_state","gender_m"]
